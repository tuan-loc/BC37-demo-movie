    ...
    if (_.isEmpty(userLogin)) {
      return (
        <Fragment>
          ...
          <NavLink to="/register">
            <button className="cursor-pointer self-center ml-2 px-8 py-3 font-semibold rounded bg-violet-400 text-gray-900">
              Sign up
            </button>
          </NavLink>
        </Fragment>
        ...
        <ul className="items-stretch hidden space-x-3 lg:flex">
          <li className="flex">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "flex items-center px-4 -mb-1 border-b-2 border-transparent text-violet-400"
