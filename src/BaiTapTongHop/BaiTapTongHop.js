    ...
    <div>
      ...
      <div className="grid grid-cols-6">
              ...
              {mangDanhMuc.map((danhMuc, index) => {
                ...
                return (
                  <li
                    ...
                    key={index}
                    className="dark:bg-gray-800 dark:text-gray-50 cursor-pointer"
                  >
                    <a
                      rel="noopener noreferrer"
                      href="#"
        ...
        <section className="col-span-5 text-gray-600 body-font">
          <h3 className="text-center text-purple-700 text-4xl mt-10">Menu</h3>
                  ...
                  return (
                    <div key={index} className="p-4 lg:w-1/3">
                      <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                        ...
                        <div className="text-center mt-2 leading-none w-full flex justify-end">
                          <span className="text-gray-400 mr-3 inline-flex items-center leading-none text-sm border-r-2 border-gray-200">
                            Giá: {item.gia}
                          </span>
                        </div>
                      </div>
